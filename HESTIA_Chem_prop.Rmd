...
QSAR_EC50 <- QSAR_merge %>% 
              ...
              filter(Species != c("Aquatic Community", "Animalia", "Wild", "Unspecified")
                     )#need to remove the bad species definitions
...
QSAR_Phyla_view <- QSAR_EC50 %>% 
                      count(Phylum)
QSAR_Phyla_fix <- QSAR_EC50 %>% 
                      filter(is.na(Phylum))
